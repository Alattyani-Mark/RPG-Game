...
let lvl_description = [
    ["Megérkeztél a világba kezdj el gyűjtögetni!", "Wigfrid.png"],
    ["Megtanultad az első csata indulódat","éneklvl.png"],
    ["A pingvinek nem is olyan erősek, mi?","ghostlvl.png"],
    ["Mostmár nincs olyan akit ne tudnál legyőzni (Még a pingvineket is igen!)", "opwig.png"]
];
...
function fight(e_name, e_damage, e_life){
    story.innerHTML += "Gyűjtögetés közben megtámadott téged egy " + e_name + "!<br>";
